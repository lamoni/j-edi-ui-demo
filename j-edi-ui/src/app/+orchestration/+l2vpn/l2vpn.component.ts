...
@Component({
  selector: 'app-l2vpn',
  templateUrl: './l2vpn.component.html',
  styleUrls: ['./l2vpn.component.css']
})
export class L2vpnComponent implements OnInit {
    ...
    private setEnpointPristine() {
        ...
        this.endpoint.outerVlanTag = undefined;
        this.endpoint.remoteSiteIdentifier = undefined;
        this.endpoint.routeDistinguisher = undefined;
        this.endpoint.siteIdentifier = undefined;
        this.endpoint.outerVlanTag = '';
...
//         console.log(finalYaml);
    ...
    onEdit(index) {
        this.endpoint = this.l2vpn.endpoints[index];
    }

    onRemove(index) {
        index++;
        this.l2vpn.endpoints = this.l2vpn.endpoints.splice(index, 1);
    }
