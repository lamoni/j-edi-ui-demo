...
export const routes: Routes = [
  {
    ...
    children: [
      {
        path: 'Service List', redirectTo: 'servicelist', pathMatch: 'full',
      ...
      {
          path: 'orchestration',
          loadChildren: 'app/+orchestration/orchestration.module#OrchestrationModule',
          data: {pageTitle: 'Orchestration'}
      },
      {path: 'opennti', loadChildren: 'app/+opennti/opennti.module#OpenNtiModule',data:{pageTitle: 'Open NTI'}},
      {path: 'topology', loadChildren: 'app/+topology/topology.module#TopologyModule',data:{pageTitle: 'Live Topology'}},
      {path: 'servicelist', loadChildren: 'app/+servicelist/servicelist.module#ServiceListModule',data:{pageTitle: 'Service List'}},
